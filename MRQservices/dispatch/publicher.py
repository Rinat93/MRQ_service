...
class Publisher(Consumer):
    ...
    async def _send_register_Service(cls):
        if cls.__global_service_start == False:
            await cls._create_channels(cls.hosts,cls.exchange,cls._systems_all,cls._route,cls.exchange_type)
    ...
    async def _register_service(cls, obj):
        if hasattr(obj, 'service') and obj.service_start == False:
            ...
            await cls._create_channels(obj.hosts, obj.exchange,obj.context, obj.service,obj.exchange_type)
